...
const PLANOS = [
  {
    ...
    emoji: "📺",
    valor: 0.99,
    descricao: "Sem anúncios, legenda única e dupla PT+EN+JP, 720p",
    cor: "#22c55e",
    features: ["Sem anúncios","Legenda única PT/EN/JP","Legenda dupla PT+EN+JP","Qualidade até 720p","Trailer integrado"]
  },
  {
    id: "premium",
    nome: "Premium",
    emoji: "💜",
    valor: 1.99,
    descricao: "ORION professor IA + legendas duplas 12 idiomas + HD",
    cor: "#f97316",
    features: ["ORION — Professor IA","Legenda dupla 12 idiomas","Sem anúncios","HD 1080p","Watch Party","Quiz ao vivo +XP"]
  },
  {
    id: "agent",
    nome: "Agente",
    emoji: "🤖",
    valor: 9.99,
    descricao: "ORION ilimitado + áudio 12 idiomas + 4K",
    cor: "#a855f7",
    popular: true,
    features: ["Tudo do Premium","ORION ilimitado","Áudio 12 idiomas","4K + Download offline","Watch Party ilimitada","Recomendações IA"]
  }
];
