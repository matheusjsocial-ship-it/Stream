...
const PLANOS = [
  {
    ...
    emoji: "💜",
    valor: 0.99,
    descricao: "Legendas duplas 12 idiomas, sem anúncios, HD",
    cor: "#f97316",
    features: ["Legenda dupla 12 idiomas","Sem anúncios","HD 1080p","Watch Party 2 pessoas"]
  },
  {
    id: "agent",
    nome: "Agente ORION",
    emoji: "🤖",
    valor: 1.99,
    descricao: "Tudo do Premium + ORION IA + Quiz + Watch Party ilimitada",
    cor: "#a855f7",
    popular: true,
    features: ["Tudo do Premium","ORION professor IA","Quiz ao vivo +XP","Watch Party ilimitada","4K + Download offline"]
  }
];
