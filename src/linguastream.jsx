              ...
              <>
                ...
                <label style={{display:"flex",alignItems:"flex-start",gap:8,cursor:"pointer",background:"rgba(37,211,102,.06)",border:"1px solid rgba(37,211,102,.2)",borderRadius:8,padding:"8px 10px"}}>
                  <input type="checkbox" checked={form.wp}
                    ...
                    style={{marginTop:2,accentColor:"#25d366",flexShrink:0}}/>
                  <span style={{fontSize:10,lineHeight:1.5,color:"#94a3b8"}}>{t?.wpConsent||"📲 WhatsApp: Autorizo notificações. Cancelo com PARAR."}</span>
                </label>
